...
Scheduler.plugin(function(e) {
    e._temp_matrix_scope = function() {
        e.matrix = {}, e._merge = function(e, t) { for (var a in t) "undefined" == typeof e[a] && (e[a] = t[a]) }, e.createTimelineView = function(t) {
            e._skin_init(), e._merge(t, {
                ...
                second_scale: !1,
                round_position: !1,
                _logic: function(t, a, n) { var i = {}; return e.checkEvent("onBeforeSectionRender") && (i = e.callEvent("onBeforeSectionRender", [t, a, n])), i }
            ...
            e.render_data = function(n, i) {
                ...
                }, e.matrix[t.name] = t, e.templates[t.name + "_cell_value"] = function(e) { return e ? e.length : "" }, e.templates[t.name + "_cell_class"] = function(e) { return "" }, e.templates[t.name + "_scalex_class"] = function(e) { return "" }, e.templates[t.name + "_second_scalex_class"] = function(e) { return "" }, e.templates[t.name + "_scaley_class"] = function(e, t, a) { return "" }, e.templates[t.name + "_scale_label"] = function(e, t, a) { return t }, e.templates[t.name + "_tooltip"] = function(e, t, a) {
                    return a.text
                ...
                e.date["add_" + t.name + "_private"] = function(a, n) { var i = n,
                        r = t.x_unit; if ("minute" == t.x_unit || "hour" == t.x_unit) { var o = i; "hour" == t.x_unit && (o *= 60), o % 1440 || (i = o / 1440, r = "day") } return e.date.add(a, i, r) }, e.date["add_" + t.name] = function(a, n, i) {
                    ...
                    return r
                }, e.date[t.name + "_start"] = function(a) { var n = e.date[t.x_unit + "_start"] || e.date.day_start,
                        i = n.call(e.date, a),
                        r = i.getTimezoneOffset();
                    i = e.date.add(i, t.x_step * t.x_start, t.x_unit); var o = i.getTimezoneOffset(); return r != o && i.setTime(i.getTime() + 6e4 * (o - r)), i }, e.callEvent("onOptionsLoad", [t]), e[t.name + "_view"] = function(a) { a ? e._set_timeline_dates(t) : e._renderMatrix.apply(t, arguments) };
            var n = new Date;
            ...
            e["mouse_" + t.name] = function(a) {
                ...
                if (a.x = 0, a.force_redraw = !0, a.custom = !0, "move" == this._drag_mode && this._drag_id && this._drag_event) {
                    ...
                    if (a._ignores = this._ignores_detected || t._start_correction || t._end_correction, void 0 === r._move_delta && (r._move_delta = (n.start_date - i) / 6e4, this.config.preserve_length && a._ignores && (r._move_delta = this._get_real_event_length(n.start_date, i, t),
                            r._event_length = this._get_real_event_length(n.start_date, n.end_date, t))), this.config.preserve_length && a._ignores) { var o = (r._event_length, this._get_fictional_event_length(i, r._move_delta, t, !0));
                        i = new Date(i - o) } else i = e.date.add(i, r._move_delta, "minute")
                }
            ...
            return a
        }, e._populate_timeline_rendered = function(t) { e._rendered = []; for (var a = t.getElementsByTagName("DIV"), n = 0; n < a.length; n++) a[n].getAttribute("event_id") && e._rendered.push(a[n]) }, e._get_timeline_event_height = function(e, t) { var a = e[t.y_property],
                n = t.event_dy; return "full" == t.event_dy && (n = t.section_autoheight ? t._section_height[a] - 6 : t.dy - 3), t.resize_events && (n = Math.max(Math.floor(n / e._count), t.event_min_dy)), n }, e._get_timeline_event_y = function(t, a) {
            var n = t,
                i = 2 + n * a + (n ? 2 * n : 0);
            ...
            if (x) { var k = x.cells[1].firstChild;
        ...
        }, e._timeline_get_rounded_date = function(t, a) { var n = e._get_date_index(this, t),
                i = this._trace_x[n]; return a && +t != +this._trace_x[n] && (i = this._trace_x[n + 1] ? this._trace_x[n + 1] : e.date.add(this._trace_x[n], this.x_step, this.x_unit)), new Date(i) }, e._timeline_skip_ignored = function(t) {
            ...
            if (t && "cell" != this.render) {
                e._timeline_skip_ignored.call(this, t), t.sort(this.sort || function(e, t) { return e.start_date.valueOf() == t.start_date.valueOf() ? e.id > t.id ? 1 : -1 : e.start_date > t.start_date ? 1 : -1 });
                for (var n = [], i = t.length, r = 0; i > r; r++) {
                    ...
                    for (this.round_position ? e._timeline_get_rounded_date.apply(this, [o.end_date, !0]) : o.end_date; n.length;) { var l = n[n.length - 1]; if (!(l.end_date.valueOf() <= d.valueOf())) break;
                        n.splice(n.length - 1, 1) }
                    for (var s = !1, _ = 0; _ < n.length; _++) { var c = n[_]; if (c.end_date.valueOf() <= d.valueOf()) { s = !0, o._sorder = c._sorder, n.splice(_, 1), o._inner = !0; break } }
                                    ...
                                    for (var u = 0; u < n.length; u++) {
                                        for (var h = !1, p = 0; p < n.length; p++)
                                            if (n[p]._sorder == u) {
                                                h = !0;
                                                break
                                            } if (!h) { o._sorder = u; break }
                                    } else o._sorder = 0;
                                o._inner = !0
                            } else { for (var v = n[0]._sorder, m = 1; m < n.length; m++) n[m]._sorder > v && (v = n[m]._sorder);
            ...
            for (var r = 0; r < this.y_unit.length; r++) {
                ...
                e._merge(_, { height: this.dy }), this.section_autoheight && (this.y_unit.length * _.height < t.offsetHeight && (_.height = Math.max(_.height, Math.floor((t.offsetHeight - 1) / this.y_unit.length))),
                ...
                if (this.fit_events) { var u = this._events_height[this.y_unit[r].key] || 0;
            ...
            for (var p = t.firstChild.rows, v = null, r = 0, m = s.length; m > r; r++) { v = this.y_unit[r], l.push(s[r].height); var g = v.key,
            ...
            for (var i = (this.x_size + (t ? e._ignores_detected : 0), 0), r = 0; + n > +a;)
                if (this._trace_x[r] = new Date(a),
                    ...
                    else if (i >= this.x_size) { e._max_date = a; break }
            ...
            for (var M = 0; M < this._trace_x.length; M++)
                if (!e._ignores[M]) { d = this._trace_x[M], e._render_x_header(M, r[M], d, t); var A = e.templates[this.name + "_scalex_class"](d);
                    A && (t.lastChild.className += " " + A) } e.xy.scale_height = a;
            var C = this._trace_x;
            t.onclick = function(t) { var a = e._timeline_locate_hcell(t);
                a && e.callEvent("onXScaleClick", [a.x, C[a.x], t || event]) }, t.ondblclick = function(t) {
        ...
        }, e._timeline_reset_scale_height = function(t) { if (this._header_resized && (!t || !this.second_scale)) { e.xy.scale_height /= 2, this._header_resized = !1; var a = e._els.dhx_cal_header[0];
                a.className = a.className.replace(/ dhx_second_cal_header/gi, "") } }, e._timeline_set_full_view = function(t) {
        ...
        }, e._timeline_hideToolTip = function() { e._tooltip && (e._tooltip.style.display = "none", e._tooltip.date = "") }, e._timeline_showToolTip = function(t, a, n) {
            if ("cell" == t.render) {
                var i = a.x + "_" + a.y,
                    r = t._matrix[a.y][a.x];
        ...
        }, e._matrix_tooltip_handler = function(t) { var a = e.matrix[e._mode]; if (a && "cell" == a.render) { if (a) { var n = e._locate_cell_timeline(t),
                        t = t || event;
                    t.target || t.srcElement; if (n) return e._timeline_showToolTip(a, n, getOffset(n.src)) } e._timeline_hideToolTip() } }, e._init_matrix_tooltip = function() {
        ...
        }, e._set_timeline_dates = function(t) { e._min_date = e.date[t.name + "_start"](new Date(e._date)), e._max_date = e.date["add_" + t.name + "_private"](e._min_date, t.x_size * t.x_step), e.date[t.x_unit + "_start"] && (e._max_date = e.date[t.x_unit + "_start"](e._max_date)), e._table_view = !0 }, e._renderMatrix = function(t, a) { a || (e._els.dhx_cal_data[0].scrollTop = 0), e._set_timeline_dates(this), e._timeline_set_full_view.call(this, t) }, e._timeline_html_index = function(t) {
            for (var a = t.parentNode.childNodes, n = -1, i = 0; i < a.length; i++)
                if (a[i] == t) { n = i; break } var r = n;
            if (e._ignores_detected)
                for (var o in e._ignores) e._ignores[o] && r >= 1 * o && r++;
            return r
        }, e._timeline_locate_hcell = function(t) { t = t || event; for (var a = t.target ? t.target : t.srcElement; a && "DIV" != a.tagName;) a = a.parentNode; if (a && "DIV" == a.tagName) { var n = e._getClassName(a).split(" ")[0]; if ("dhx_scale_bar" == n) return { x: e._timeline_html_index(a), y: -1, src: a, scale: !0 } } }, e._locate_cell_timeline = function(t) {
            t = t || event;
            ...
            for (var _ = !1; 0 === n.x && "dhx_cal_data" != e._getClassName(a) && a.parentNode;) { if ("dhx_matrix_scell" == e._getClassName(a).split(" ")[0]) { _ = !0; break } a = a.parentNode }
        ...
        e._click.dhx_marked_timespan = e._click.dhx_cal_data = function(a) {
            ...
            return n
        }, e.dblclick_dhx_matrix_cell = function(t) { var a = e.matrix[e._mode]; if (a) { var n = e._locate_cell_timeline(t);
        ...
        }), e.attachEvent("onBeforeDrag", function(t, a, n) { return !e._isRender("cell") }), e.attachEvent("onEventChanged", function(e, t) { t._timed = this.isOneDayEvent(t) }), e.attachEvent("onBeforeEventChanged", function(e, t, a, n) { return e && (e._move_delta = void 0), n && (n._move_delta = void 0), !0 }), e._is_column_visible = function(t) {
        ...
        e._render_marked_timespan = function(t, a, i, r, o) {
            ...
            if (e.matrix && e.matrix[e._mode]) {
                ...
                var v = [];
                if (t.days > 6) { var m = new Date(t.days);
                    e.date.date_part(new Date(r)) <= +m && +o >= +m && v.push(m) } else v.push.apply(v, e._get_dates_by_index(t.days));
                    ...
                    for (var p = 0; p < v.length; p++)
                        for (var y = v[p], x = 0; x < g.length; x += 2) {
                            ...
                            if (D = new Date(D.valueOf() + 1e3 * (D.getTimezoneOffset() - y.getTimezoneOffset()) * 60), E = new Date(E.valueOf() + 1e3 * (E.getTimezoneOffset() - y.getTimezoneOffset()) * 60), E > r && o > D) {
                                ...
                                N.className = f;
                                var S = e._timeline_getX({ start_date: D }, !1, d) - 1,
                                    M = e._timeline_getX({ start_date: E }, !1, d) - 1,
                                    A = Math.max(1, M - S - 1),
        ...
        e._append_mark_now = function(t, a) { if (e.matrix && e.matrix[e._mode]) { var n = e._currentDate(),
                    r = e._get_zone_minutes(n),
                    o = { days: +e.date.date_part(n), zones: [r, r + 1], css: "dhx_matrix_now_time", type: "dhx_now_time" }; return e._render_marked_timespan(o) } return i.apply(e, [t, a]) };
        ...
        e._on_scale_add_marker = function(t, a) {
        ...
        }, e._update_timeline_section = function(e) { var t = e.view,
                a = e.event,
                n = e.pos; if (a) { if (a[t.y_property] != n.section) { var i = this._get_timeline_event_height(a, t);
                    a._sorder = this._get_dnd_order(a._sorder, i, t._section_height[n.section]) } a[t.y_property] = n.section } }, e._get_date_index = function(e, t) {
            ...
            for (l; l <= this._cols.length - 1; l++)
                if (i = this._cols[l], d += i, d > o.x) { n = (o.x - (d - i)) / i, n = 0 > n ? 0 : n; break } if (r.round_position) { var s = 1,
                    _ = e.getState().drag_mode;
                _ && "move" != _ && "create" != _ && (s = .5), n >= s && l++, n = 0 }
            if (0 === l && this._ignores[0])
                for (l = 1, n = 0; this._ignores[l];) l++;
            else if (l == this._cols.length && this._ignores[l - 1]) { for (l = this._cols.length - 1, n = 0; this._ignores[l];) l--;
                l++ }
            var c;
            ...
            else { var u = n * i * r._step + r._start_correction;
                c = new Date(+r._trace_x[l] + u) }
            return c
        }, e.attachEvent("onBeforeTodayDisplayed", function() { for (var t in e.matrix) { var a = e.matrix[t];
                a.x_start = a._original_x_start } return !0 }), e.attachEvent("onOptionsLoad", function() {
        ...
        }), e.attachEvent("onSchedulerResize", function() { if (e.matrix[this._mode]) { var t = e.matrix[this._mode]; return e._renderMatrix.call(t, !0, !0), !1 } return !0 }), e.attachEvent("onBeforeDrag", function(t, a, n) { if ("resize" == a) { var i = n.target || n.srcElement,
                    r = e._getClassName(i);
                r.indexOf("dhx_event_resize_end") < 0 ? e._drag_from_start = !0 : e._drag_from_start = !1 } return !0 })
